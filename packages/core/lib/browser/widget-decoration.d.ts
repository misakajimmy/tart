...
export declare namespace WidgetDecoration {
     ...
     */
    namespace Styles {
        const CAPTION_HIGHLIGHT_CLASS = "tart-caption-highlight";
        const CAPTION_PREFIX_CLASS = "tart-caption-prefix";
        const CAPTION_SUFFIX_CLASS = "tart-caption-suffix";
        const ICON_WRAPPER_CLASS = "tart-icon-wrapper";
        const DECORATOR_SIZE_CLASS = "tart-decorator-size";
        const DECORATOR_SIDEBAR_SIZE_CLASS = "tart-decorator-sidebar-size";
        const TOP_RIGHT_CLASS = "tart-top-right";
        const BOTTOM_RIGHT_CLASS = "tart-bottom-right";
        const BOTTOM_RIGHT_SIDEBAR_CLASS = "tart-bottom-right-sidebar";
        const BOTTOM_LEFT_CLASS = "tart-bottom-left";
        const TOP_LEFT_CLASS = "tart-top-left";
    }
    /**
