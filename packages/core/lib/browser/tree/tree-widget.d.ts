...
export declare const TREE_CLASS = "tart-Tree";
export declare const TREE_CONTAINER_CLASS = "tart-TreeContainer";
export declare const TREE_NODE_CLASS = "tart-TreeNode";
export declare const TREE_NODE_CONTENT_CLASS = "tart-TreeNodeContent";
export declare const TREE_NODE_INFO_CLASS = "tart-TreeNodeInfo";
export declare const TREE_NODE_TAIL_CLASS = "tart-TreeNodeTail";
export declare const TREE_NODE_SEGMENT_CLASS = "tart-TreeNodeSegment";
export declare const TREE_NODE_SEGMENT_GROW_CLASS = "tart-TreeNodeSegmentGrow";
export declare const EXPANDABLE_TREE_NODE_CLASS = "tart-ExpandableTreeNode";
export declare const COMPOSITE_TREE_NODE_CLASS = "tart-CompositeTreeNode";
export declare const TREE_NODE_CAPTION_CLASS = "tart-TreeNodeCaption";
export declare const TREE_NODE_INDENT_GUIDE_CLASS = "tart-tree-node-indent";
...
export declare class TreeWidget extends ReactWidget implements StatefulWidget {
    ...
    protected renderTailDecorationsForNode(node: TreeNode, props: NodeProps, tailDecorations: (TreeDecoration.TailDecoration | TreeDecoration.TailDecorationIcon | TreeDecoration.TailDecorationIconClass)[]): React.ReactNode;
    /**
