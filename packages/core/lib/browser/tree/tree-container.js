...
export function createTreeContainer(parent, props) {
    ...
    child.bind(SearchBoxFactory).toFactory(context => (options) => {
...
//# sourceMappingURL=../../../lib/browser/tree/tree-container.js.map
