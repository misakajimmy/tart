...
export const BrowserKeyboardModule = new ContainerModule((bind, unbind, isBound, rebind) => {
    ...
    // bind(KeyboardLayoutProvider).toSelf().inSingletonScope();
...
export default BrowserKeyboardModule;

//# sourceMappingURL=../../../lib/browser/keyboard/browser-keyboard-module.js.map
