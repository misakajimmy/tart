...
export declare namespace Styles {
    const BREADCRUMBS = "tart-breadcrumbs";
    const BREADCRUMB_ITEM = "tart-breadcrumb-item";
    const BREADCRUMB_POPUP_OVERLAY_CONTAINER = "tart-breadcrumbs-popups-overlay";
    const BREADCRUMB_POPUP = "tart-breadcrumbs-popup";
    const BREADCRUMB_ITEM_HAS_POPUP = "tart-breadcrumb-item-haspopup";
}
