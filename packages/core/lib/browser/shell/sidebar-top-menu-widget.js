 ...
 */
let SidebarTopMenuWidget = class SidebarTopMenuWidget extends SidebarMenuWidget {
};
SidebarTopMenuWidget = __decorate([
    injectable()
], SidebarTopMenuWidget);
export { SidebarTopMenuWidget };

//# sourceMappingURL=../../../lib/browser/shell/sidebar-top-menu-widget.js.map
