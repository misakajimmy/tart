 ...
 ********************************************************************************/
import { createPreferenceProxy, PreferenceContribution, PreferenceService } from './preferences';
import { SUPPORTED_ENCODINGS } from './supported-encodings';
import { FrontendApplicationConfigProvider } from './frontend-application-config-provider';
import { isOSX } from '../common/os';
import { nls } from '../common/nls';
export const corePreferenceSchema = {
    'type': 'object',
    properties: {
        ...
        'files.encoding': {
            ...
            'default': 'utf8',
            'description': nls.localizeByDefault('The default character set encoding to use when reading and writing files. This setting can also be configured per language.'),
        ...
        'keyboard.dispatch': {
            ...
            default: 'code',
            description: nls.localizeByDefault('Controls the dispatching logic for key presses to use either `code` (recommended) or `keyCode`.')
        },
...
export function createCorePreferences(preferences, schema = corePreferenceSchema) {
    return createPreferenceProxy(preferences, schema);
}
export function bindCorePreferences(bind) {
...
//# sourceMappingURL=../../lib/browser/core-preferences.js.map
