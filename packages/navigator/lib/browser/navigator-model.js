...
import { CompositeTreeNode, ExpandableTreeNode, open, OpenerService, SelectableTreeNode } from '@tart/core/lib/browser';
...
let FileNavigatorModel = class FileNavigatorModel extends FileTreeModel {
    *getNodesByUri(uri) {
    ...
    async createRoot() {
        if (this.workspaceService.opened) {
            ...
            for (const root of roots) {
                workspaceNode.children.push(await this.fileNavigatorTree.createWorkspaceRoot(root, workspaceNode));
            }
...
__decorate([
    inject(FileNavigatorTree)
], FileNavigatorModel.prototype, "fileNavigatorTree", void 0);
__decorate([
...
export { FileNavigatorModel };

//# sourceMappingURL=../../lib/browser/navigator-model.js.map
