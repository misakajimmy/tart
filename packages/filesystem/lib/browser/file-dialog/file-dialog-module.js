...
export const FileDialogModule = new ContainerModule(bind => {
    ...
    bind(LocationListRendererFactory).toFactory(context => (options) => {
    ...
    bind(FileDialogTreeFiltersRendererFactory).toFactory(context => (options) => {
        const childContainer = context.container.createChild();
...
//# sourceMappingURL=../../../lib/browser/file-dialog/file-dialog-module.js.map
