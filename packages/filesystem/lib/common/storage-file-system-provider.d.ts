import { FileChange, FileDeleteOptions, FileOpenOptions, FileOverwriteOptions, FileReadStreamOptions, FileSystemProvider, FileSystemProviderCapabilities, FileType, FileUpdateOptions, FileUpdateResult, FileWriteOptions, Stat, WatchOptions } from './files';
...
export declare class StorageFileSystemProvider implements Required<FileSystemProvider>, Disposable {
