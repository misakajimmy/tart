...
const check_fs = () => {
    ...
    if (!(root.type == LocalStorage.Type.directory && root.name == "/"))
        return false;
    return true;
};
// initialize the fs
...
export const rename_dir = (id, newName) => {
    let fsList = load_fs();
    fsList[id].name = newName;
    store_fs(fsList);
    return id;
};
export const move_dir = (id, parent) => {
    let fsList = load_fs();
...
(function (LocalStorage) {
    ...
    })(Type = LocalStorage.Type || (LocalStorage.Type = {}));
})(LocalStorage || (LocalStorage = {}));

//# sourceMappingURL=../../../lib/common/localstorage/localstorage-fs.js.map
