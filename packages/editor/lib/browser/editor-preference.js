...
export const EDITOR_FONT_DEFAULTS = {
    fontFamily: (isOSX ? DEFAULT_MAC_FONT_FAMILY : (isWindows ? DEFAULT_WINDOWS_FONT_FAMILY : DEFAULT_LINUX_FONT_FAMILY)),
    fontWeight: 'normal',
    fontSize: (isOSX ? 12 : 14),
    lineHeight: 0,
    letterSpacing: 0,
};
...
const codeEditorPreferenceProperties = {
    ...
    'editor.semanticHighlighting.enabled': {
        ...
        'description': nls.localizeByDefault('Controls whether the semanticHighlighting is shown for the languages.json that support it.')
    },
    'editor.stablePeek': {
        'type': 'boolean',
        'default': false,
    ...
    'editor.autoIndent': {
        'enumDescriptions': [
            ...
            nls.localizeByDefault('The editor will keep the current line\'s indentation, honor language defined brackets and invoke special onEnterRules defined by languages.json.'),
            nls.localizeByDefault('The editor will keep the current line\'s indentation, honor language defined brackets, invoke special onEnterRules defined by languages.json, and honor indentationRules defined by languages.json.')
        ],
...
export const editorPreferenceSchema = {
    'type': 'object',
    'scope': 'resource',
    'overridable': true,
...
export function createEditorPreferences(preferences, schema = editorPreferenceSchema) {
    return createPreferenceProxy(preferences, schema);
}
export function bindEditorPreferences(bind) {
    bind(EditorPreferences).toDynamicValue(ctx => {
        const preferences = ctx.container.get(PreferenceService);
        const contribution = ctx.container.get(EditorPreferenceContribution);
...
//# sourceMappingURL=../../lib/browser/editor-preference.js.map
