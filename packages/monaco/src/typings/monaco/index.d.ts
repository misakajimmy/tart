...
declare module monaco.instantiation {
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/instantiation/common/instantiation.ts#L86
...
declare module monaco.textModel {
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/common/model/textModel.ts#L62
...
declare module monaco.editor {
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/common/model.ts#L1264
    ...
    export interface ICodeEditor {
         ...
         * @internal
         */
        // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/browser/editorBrowser.ts#L736
        setDecorations(decorationTypeKey: string, ranges: editorCommon.IDecorationOptions[]): void;

        /**
         * @internal
         */
        // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/browser/editorBrowser.ts#L746
        removeDecorations(decorationTypeKey: string): void;
    }

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/undoRedo/common/undoRedo.ts#L92-L111
    export class UndoRedoSource {
    }

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/browser/services/bulkEditService.ts#L67
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/browser/services/bulkEditService.ts#L79
    export interface IBulkEditResult {
        ariaSummary: string;
    }

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/browser/services/bulkEditService.ts#L83
    export type IBulkEditPreviewHandler = (edit: ResourceEdit[], options?: IBulkEditOptions) => Promise<ResourceEdit[]>;

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/browser/services/bulkEditService.ts#L85
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/browser/widget/diffNavigator.ts#L43
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/browser/widget/diffNavigator.ts#L16
    export interface IDiffRange {
        readonly range: Range;
    }

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/standalone/browser/standaloneCodeEditor.ts#L245
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/browser/widget/codeEditorWidget.ts#L107
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/contrib/codeAction/codeActionCommands.ts#L68
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/contrib/codeAction/codeActionUi.ts#L21
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/contrib/codeAction/lightBulbWidget.ts#L48
    export interface LightBulbWidget {
        readonly _domNode: HTMLDivElement;
    }

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/contrib/codelens/codelensController.ts#L28
    export interface CodeLensContribution {
        readonly _lenses: CodeLensWidget[];
    }

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/contrib/codelens/codelensWidget.ts#L178
    export interface CodeLensWidget {
        readonly _contentWidget?: CodeLensContentWidget;
    }

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/contrib/codelens/codelensWidget.ts#L49
    export interface CodeLensContentWidget {
        readonly _domNode: HTMLElement;
    }

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/contrib/hover/hover.ts#L30
    export interface ModesHoverController {
        readonly _contentWidget: ModesContentHoverWidget | null;
    }

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/base/browser/ui/hover/hoverWidget.ts#L13-L39
    export class HoverWidget extends Disposable {
        readonly contentsDomNode: HTMLElement;
    }

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/contrib/hover/modesContentHover.ts#L177
    export interface ModesContentHoverWidget {
        readonly _isVisible: boolean;
        readonly _hover: HoverWidget;
    }

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/common/controller/cursor.ts#L122
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/editor/common/editor.ts#L68
    ...
    export interface IResourceInputOptions {
         ...
         */
        // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/editor/common/editor.ts#L150
        readonly preserveFocus?: boolean;

        /**
         * Will reveal the editor if it is already opened and visible in any of the opened editor groups.
         */
        // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/editor/common/editor.ts#L175
        readonly revealIfVisible?: boolean;

        /**
         * Text editor selection.
         */
        // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/editor/common/editor.ts#L270
        readonly selection?: Partial<monaco.IRange>;
    }

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/browser/services/codeEditorService.ts#L16
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/base/common/lifecycle.ts#L253
    export interface IReference<T> extends monaco.IDisposable {
        readonly object: T;
    }

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/common/services/resolverService.ts#L14
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/common/services/resolverService.ts#L34
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/common/services/resolverService.ts#L42 &&
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/editor/common/editor.ts#L9
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/base/browser/contextmenu.ts#L18
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/base/common/actions.ts#L26
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/contextview/browser/contextView.ts#L39
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/common/editorCommon.ts#L680
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/common/editorCommon.ts#L664
    export interface IThemeDecorationInstanceRenderOptions {
        before?: IContentDecorationRenderOptions;
        after?: IContentDecorationRenderOptions;
    }

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/common/editorCommon.ts#L672
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/common/editorCommon.ts#L628
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/common/editorCommon.ts#L652
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/common/editorCommon.ts#L592
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/common/model.ts#L522
    ...
    export interface ITextModel {
         ...
         * @internal
         */
        // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/common/model.ts#L890
         ...
         * @internal
         */
        // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/common/model.ts#L869
        forceTokenization(lineNumber: number): void;

        // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/common/model.ts#L617
         ...
         * @internal
         */
        // https://github.com/wm-ide/vscode/blob/standalone/0.19.x/src/vs/editor/common/model.ts#L833-L837
...
declare module monaco.commands {
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/commands/common/commands.ts#L60
    export const CommandsRegistry: {
        getCommands(): Map<string, { id: string, handler: (...args: any) => any }>;
    };

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/commands/common/commands.ts#L16
    export interface ICommandEvent {
        commandId: string;
        args: any[];
    }

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/commands/common/commands.ts#L21
...
declare module monaco.actions {
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/actions/common/actions.ts#L21
    export interface ILocalizedString {
        value: string;
        original: string;
    }

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/actions/common/actions.ts#L41
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/actions/common/actions.ts#L53
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/actions/common/actions.ts#L61
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/actions/common/actions.ts#L191
    export interface IMenuRegistry {
        /**
         * Retrieves all the registered menu items for the given menu.
         * @param menuId - see https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/actions/common/actions.ts#L89
         */
        getMenuItems(menuId: MenuId): Array<IMenuItem | ISubmenuItem>;
    }

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/actions/common/actions.ts#L70
    export function isIMenuItem(item: IMenuItem | ISubmenuItem): item is IMenuItem;

    /**
     * The shared menu registry singleton.
     */
        // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/actions/common/actions.ts#L202
    export const MenuRegistry: IMenuRegistry;

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/actions/common/actions.ts#L356
    export class MenuItemAction {
    }
}

declare module monaco.platform {
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/base/common/platform.ts#L245
...
declare module monaco.keybindings {
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/keybinding/common/keybindingResolver.ts#L19
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/base/common/keyCodes.ts#L443
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/base/common/keyCodes.ts#L503
    export class ChordKeybinding {
        readonly parts: SimpleKeybinding[];
    }

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/base/common/keyCodes.ts#L540
    export type Keybinding = ChordKeybinding;

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/keybinding/common/keybindingsRegistry.ts#L12
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/keybinding/common/keybindingsRegistry.ts#L73
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/keybinding/common/keybindingsRegistry.ts#L243
    export const KeybindingsRegistry: IKeybindingsRegistry;

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/base/common/keyCodes.ts#L542
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/base/common/keyCodes.ts#L564
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/keybinding/common/usLayoutResolvedKeybinding.ts#L13
    export class USLayoutResolvedKeybinding {
        public static getDispatchStr(keybinding: SimpleKeybinding): string | null;
    }

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/base/common/keybindingLabels.ts#L17
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/base/common/keybindingLabels.ts#L24
    export interface KeyLabelProvider<T extends Modifiers> {
        (keybinding: T): string | null;
    }

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/base/common/keybindingLabels.ts#L28
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/base/common/keybindingLabels.ts#L61
    export const UILabelProvider: ModifierLabelProvider;

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/base/common/keybindingLabels.ts#L88
    export const AriaLabelProvider: ModifierLabelProvider;

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/base/common/keybindingLabels.ts#L116
    export const ElectronAcceleratorLabelProvider: ModifierLabelProvider;

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/base/common/keybindingLabels.ts#L136
...
declare module monaco.services {
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/standalone/browser/standaloneLanguages.ts#L107
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/common/services/resolverService.ts#L12
    export const ITextModelService: any;

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/opener/common/opener.ts#L15
    export interface OpenInternalOptions {
        readonly openToSide?: boolean;
    }

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/opener/common/opener.ts#L35
    export interface OpenExternalOptions {
        readonly openExternal?: boolean
    }

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/opener/common/opener.ts#L49
    export interface IOpener {
        open(resource: monaco.Uri | string, options?: OpenInternalOptions | OpenExternalOptions): Promise<boolean>;
    }

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/browser/services/openerService.ts#L94
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/browser/services/codeEditorService.ts#L14
    export const ICodeEditorService: any;

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/configuration/common/configuration.ts#L16
    export const IConfigurationService: any;

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/configuration/common/configurationModels.ts#L377
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/configuration/common/configuration.ts#L30-L38
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/configuration/common/configuration.ts#L51
    export interface IConfigurationChange {
        keys: string[];
        overrides: [string, string[]][];
    }

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/configuration/common/configuration.ts#L56
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/configuration/common/configuration.ts#L25
    export interface IConfigurationOverrides {
        overrideIdentifier?: string | null;
        resource?: monaco.Uri | null;
    }

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/standalone/browser/simpleServices.ts#L445
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/browser/services/codeEditorServiceImpl.ts#L84
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/standalone/browser/simpleServices.ts#L264
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/standalone/browser/standaloneServices.ts#L66
    export class LazyStaticService<T> {
        get(overrides?: monaco.editor.IEditorOverrideServices): T;
    }

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/theme/common/themeService.ts#L86
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/standalone/common/standaloneThemeService.ts#L29
    export interface IStandaloneThemeService extends monaco.theme.IThemeService {
        // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/standalone/browser/standaloneThemeServiceImpl.ts#L200
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/standalone/common/standaloneThemeService.ts#L24
    export interface IStandaloneTheme extends monaco.theme.IColorTheme {
        // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/standalone/browser/standaloneThemeServiceImpl.ts#L33
        themeData: monaco.editor.IStandaloneThemeData

        tokenTheme: TokenTheme;

        // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/theme/common/themeService.ts#L105
        getColor(color: string, useDefault?: boolean): monaco.color.Color | undefined;

        getTokenStyleMetadata(type: string, modifiers: string[], modelLanguage: string): ITokenStyle | undefined;
    }

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/common/modes/supports/tokenization.ts#L188
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/common/modes.ts#L27
    export const enum LanguageId {
        Null = 0,
        PlainText = 1
    }

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/common/modes.ts#L35
    export class LanguageIdentifier {
        public readonly id: LanguageId;
        readonly language: string;
    }

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/common/modes.ts#L58
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/common/services/modeService.ts#L30
    export interface IModeService {
        // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/common/services/modeServiceImpl.ts#L46
        private
        readonly _instantiatedModes: { [modeId: string]: IMode; };
        private
        readonly _onLanguagesMaybeChanged: Emitter<void>;
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/common/services/modeService.ts#L25
    export interface ILanguageSelection {
        readonly languageIdentifier: LanguageIdentifier;
    }

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/instantiation/common/serviceCollection.ts#L9
    export interface ServiceCollection {
        set<T>(id: any, instanceOrDescriptor: T): T;
    }

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/markers/common/markers.ts#L12
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/standalone/browser/standaloneServices.ts#L62
...
declare module monaco.theme {
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/theme/common/themeService.ts#L93
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/theme/common/themeService.ts#L143
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/base/common/styler.ts#L10
    export interface IThemable {
    }

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/theme/common/styler.ts#L171
    export function attachQuickOpenStyler(widget: IThemable, themeService: IThemeService): monaco.IDisposable;

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/theme/common/themeService.ts#L38
...
declare module monaco.color {
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/base/common/color.ts#L13
    export class RGBA {
        readonly r: number;
        readonly g: number;
        readonly b: number;
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/base/common/color.ts#L48
    export class HSLA {
        readonly h: number;
        readonly s: number;
        readonly l: number;
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/base/common/color.ts#L256
    export class Color {
        readonly rgba: RGBA;
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/theme/common/colorRegistry.ts#L19
    export interface ColorContribution {
        readonly id: string;
    }

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/theme/common/colorRegistry.ts#L28
    export type ColorFunction = (theme: monaco.theme.IColorTheme) => Color | undefined;

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/theme/common/colorRegistry.ts#L41
    export type ColorValue = string | Color | ColorFunction;

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/theme/common/colorRegistry.ts#L32
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/theme/common/colorRegistry.ts#L48
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/theme/common/colorRegistry.ts#L170
    export function getColorRegistry(): IColorRegistry;

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/theme/common/colorRegistry.ts#L475
    export function darken(colorValue: ColorValue, factor: number): ColorFunction;

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/theme/common/colorRegistry.ts#L485
    export function lighten(colorValue: ColorValue, factor: number): ColorFunction;

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/theme/common/colorRegistry.ts#L495
    export function transparent(colorValue: ColorValue, factor: number): ColorFunction;
}

declare module monaco.referenceSearch {

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/common/modes.ts#L943
    export interface Location {
        uri: Uri,
        range: IRange
    }

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/contrib/gotoSymbol/referencesModel.ts#L22
    export interface OneReference {
    }

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/contrib/gotoSymbol/referencesModel.ts#L142
    export interface ReferencesModel implements IDisposable {
        readonly references: OneReference[]
    }

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/contrib/gotoSymbol/peek/referencesWidget.ts#L193
    ...
    // see https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/contrib/gotoSymbol/peek/referencesWidget.ts#L204
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/contrib/gotoSymbol/peek/referencesController.ts#L32
...
declare module monaco.quickInput {
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/quickinput/common/quickInput.ts#L18
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/base/parts/quickinput/common/quickInput.ts#L55
    export interface IQuickNavigateConfiguration {
        keybindings: monaco.keybindings.ResolvedKeybinding[];
    }

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/base/parts/quickinput/common/quickInput.ts#L186
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/base/parts/quickinput/common/quickInput.ts#L151
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/standalone/browser/quickAccess/standaloneGotoLineQuickAccess.ts
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/standalone/browser/quickAccess/standaloneGotoSymbolQuickAccess.ts
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/base/parts/quickinput/browser/quickInput.ts#L1112
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/base/parts/quickinput/browser/quickInput.ts#L35
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/base/parts/quickinput/browser/quickInput.ts#L53
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/base/parts/quickinput/browser/quickInput.ts#L62
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/base/parts/quickinput/common/quickInput.ts#L14
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/quickinput/browser/helpQuickAccess.ts#L12
    interface IHelpQuickAccessPickItem extends monaco.quickInput.IAnythingQuickPickItem {
        prefix: string;
    }

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/base/parts/quickinput/common/quickInput.ts#L333
    export type IQuickPickItemWithResource = IQuickPickItem & { resource?: URI };

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/workbench/contrib/search/browser/anythingQuickAccess.ts#L55
    export interface IAnythingQuickPickItem extends IPickerQuickAccessItem, IQuickPickItemWithResource {
    }

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/base/parts/quickinput/common/quickInput.ts#L20
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/base/parts/quickinput/common/quickInput.ts#L306
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/base/parts/quickinput/common/quickInput.ts#L43
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/base/parts/quickinput/common/quickInput.ts#L48
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/base/parts/quickinput/common/quickInput.ts#L193
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/base/parts/quickinput/common/quickInput.ts#L283
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/base/parts/quickinput/common/quickInput.ts#L116
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/base/browser/ui/inputbox/inputBox.ts#L39
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/base/browser/ui/countBadge/countBadge.ts#L19
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/base/browser/ui/button/button.ts#L26
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/base/browser/ui/progressbar/progressbar.ts#L22
    export interface IProgressBarStyles {
        progressBarBackground?: monaco.color.Color;
    }

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/base/parts/quickinput/common/quickInput.ts#L59
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/quickinput/browser/pickerQuickAccess.ts#L92
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/quickinput/browser/pickerQuickAccess.ts#L62
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/quickinput/browser/pickerQuickAccess.ts#L36
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/base/parts/quickinput/common/quickInput.ts#L177
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/quickinput/common/quickAccess.ts#L41
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/quickinput/browser/pickerQuickAccess.ts#L13
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/quickinput/common/quickAccess.ts#L54
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/quickinput/common/quickAccess.ts#L136
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/quickinput/common/quickAccess.ts#L154
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/quickinput/common/quickAccess.ts#L33
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/quickinput/common/quickAccess.ts#L13
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/quickinput/browser/quickAccess.ts#L14
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/base/parts/quickinput/common/quickInput.ts#L319
    export interface IQuickPickItemButtonEvent<T extends IQuickPickItem> {
        button: IQuickInputButton;
        item: T;
    }

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/base/parts/quickinput/common/quickInput.ts#L324
...
declare module monaco.quickOpen {
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/base/browser/ui/inputbox/inputBox.ts#L58
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/base/browser/ui/inputbox/inputBox.ts#L90
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/base/browser/ui/iconLabel/iconLabel.ts#L34
...
declare module monaco.filters {
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/base/common/filters.ts#L15
    export interface IMatch {
        start: number;
        end: number;
    }

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/base/common/filters.ts#L337
...
declare module monaco.editorExtensions {
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/browser/editorExtensions.ts#L215
    export abstract class EditorCommand {
    }

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/browser/editorExtensions.ts#L279
    ...
    export module EditorExtensionsRegistry {
        // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/browser/editorExtensions.ts#L497
        export function getEditorActions(): EditorAction[];

        // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/browser/editorExtensions.ts#L493
        export function getEditorCommand(commandId: string): EditorCommand | undefined;
    }
}
declare module monaco.modes {

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/common/modes.ts#L209
    export interface ITokenizationSupport {
        tokenize(line: string, state: monaco.languages.IState, offsetDelta: number): any;
    }

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/common/modes.ts#L1927
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/common/modes.ts#L70
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/common/modes.ts#L148
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/base/common/glob.ts#L17
    export interface IRelativePattern {
        base: string;
        pattern: string;
    }

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/common/modes/languageSelector.ts#L10
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/common/modes/languageSelector.ts#L21
    export type LanguageSelector = string | LanguageFilter | Array<string | LanguageFilter>;

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/common/modes/languageFeatureRegistry.ts#L32
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/common/modes.ts#L1824
    export const DocumentSymbolProviderRegistry: LanguageFeatureRegistry<monaco.languages.DocumentSymbolProvider>;

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/common/modes.ts#L1799
    export const CompletionProviderRegistry: LanguageFeatureRegistry<monaco.languages.CompletionItemProvider>;

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/common/modes.ts#L1869
...
declare module monaco.suggest {
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/contrib/suggest/suggest.ts#L145
    export const enum SnippetSortOrder {
        Top, Inline, Bottom
    }

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/contrib/suggest/suggestController.ts#L99
    export interface SuggestController {
        readonly widget: monaco.async.IdleValue<SuggestWidget>;
    }

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/contrib/suggest/suggestWidget.ts#L635
    export interface SuggestWidget {
        getFocusedItem(): ISelectedSuggestion | undefined;
    }

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/contrib/suggest/suggestWidget.ts#L55
    export interface ISelectedSuggestion {
        item: CompletionItem;
    }

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/contrib/suggest/suggest.ts#L38
    export interface CompletionItem {
        completion: monaco.languages.CompletionItem;
    }

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/contrib/suggest/suggest.ts#L149
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/contrib/suggest/suggest.ts#L192
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/contrib/suggest/suggest.ts#L166
...
declare module monaco.snippetParser {
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/contrib/snippet/snippetParser.ts#L583
...
declare module monaco.contextKeyService {
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/contextkey/common/contextkey.ts#L1313
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/contextkey/common/contextkey.ts#L1337
    export interface IContextKeyService {
        // vs code has another object as argument https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/contextkey/common/contextkey.ts#L1348
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/contextkey/common/contextkey.ts#L1309
    export interface IContext {
        getValue<T>(key: string): T | undefined;
    }

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/contextkey/common/contextkey.ts#L1333
    export interface IContextKeyChangeEvent {
        affectsSome(keys: Set<string>): boolean;
    }

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/contextkey/browser/contextKeyService.ts#L352
...
declare module monaco.contextkey {
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/contextkey/common/contextkey.ts#L1327
    export const IContextKeyService: any;

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/platform/contextkey/common/contextkey.ts#L79
...
declare module monaco.mime {
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/base/common/mime.ts#L17
    ...
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/base/common/mime.ts#L41
    export function registerTextMime(association: monaco.mime.ITextMimeAssociation, warnOnOverwrite: boolean): void;

    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/base/common/mime.ts#L97
    export function clearTextMimes(onlyUserConfigured?: boolean): void;
}

declare module monaco.error {
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/base/common/errors.ts#L79
    export function onUnexpectedError(e: any): undefined;
}

declare module monaco.path {
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/base/common/path.ts#L1494
    export function normalize(uriPath: string): string;
}

declare module monaco.wordHelper {
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/common/model/wordHelper.ts#L30
    export const DEFAULT_WORD_REGEXP: RegExp;
}

declare module monaco.strings {
    // https://github.com/wm-ide/vscode/blob/standalone/0.19.x/src/vs/base/common/strings.ts#L384
    export function startsWith(haystack: string, needle: string): boolean;

    // https://github.com/wm-ide/vscode/blob/standalone/0.19.x/src/vs/base/common/strings.ts#L171
    export function endsWith(haystack: string, needle: string): boolean;
}

declare module monaco.async {
    // https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/base/common/async.ts#L842-L878
...
/**
 * overloading languages.json register functions to accept LanguageSelector,
 * check that all register functions passing a selector to registries:
 * https://github.com/wm-ide/vscode/blob/standalone/0.23.x/src/vs/editor/standalone/browser/standaloneLanguages.ts#L368-L546
 */
declare module monaco.languages {
